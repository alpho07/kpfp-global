...
@section('content')
    ...
    <section class=" section_padding_1" style="background: #E6E6E6">
        <div class="container">
            <div class="row">
                @if ($errors->any())
            ...
            <div id="smartwizard">
                ...
                <div class="tab-content" style="margin-top: 60px !important;">
                                                ...
                                                @if ($document->id < 5)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($uploaded_documents->isEmpty())
                                                                <div class="text-danger">No document uploaded</div>
                                                            @else
                                                                @foreach ($uploaded_documents as $studentDocument)
                                                                    @if ($studentDocument->document_id == $document->id)
                                                                        <table>
                                                                            <tr>
                                                                                <td> <a
                                                                                        href={{ Storage::url(@$studentDocument->file_path) }}>{{ 'Download_v' . $studentDocument->version }}</a>
                                                                                </td>
                                                                                <td>
                                        ...
                                        <table class="paper-style table  table-responsive" style="background:#F9F9F9">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <b>APPLICATION DATE: <input
                                                                ...
                                                                id="application_date" class="form-control " readonly
                                                                required></b>
                                                    </td>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        Preffered Name: <input type="text" name="preffered_name"
                                                            ...
                                                            id="preffered_name" class="form-control" required>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="1">
                                                        Town/City: <br>
                                                        <textarea id="town_city" name="town_city" class="form-control" required>
                                                    ...
                                                    <td colspan="2">
                                                        ...
                                                        Current Area/Department of Work: <input type="text" required
                                                            ...
                                                            id="preauth_inst_no_of_work_yrs" class="form-control">
                                                        <br>
                                                        Employment/Licence No: <input type="text" name="license_no"
                                                            required
                                                            value="{{  $application[0]->license_no ?? '' }}"
                                                            id="license_no" class="form-control"> <br>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        ...
                                                        Indicate Training Institution applied with: <input type="text"
                                                            ...
                                                            id="training_institution_with" class="form-control">
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        Title: <input type="text" name="emergency_title" required
                                                            ...
                                                            id="emergency_title" class="form-control">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        Email: <input type="email" name="emergency_email" required
                                                            ...
                                                            id="emergency_email" class="form-control">
                                                    </td>
                                                    <td colspan="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="academic_start_date[]"
                                                            ...
                                                            id="academic_start_date7" class="form-control datepicker-1">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="academic_completion[]"
                                                            value="{{  $academic_history[1]->academic_completion ?? '' }}"
                                                            id="academic_completion8" class="form-control datepicker-1">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="academic_start_date[]"
                                                            ...
                                                            id="academic_start_date2" class="form-control datepicker-1">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="academic_completion[]"
                                                            value="{{  $academic_history[2]->academic_completion ?? '' }}"
                                                            id="academic_completion2" class="form-control datepicker-1">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="academic_diplomas[]"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="academic_start_date[]"
                                                            ...
                                                            id="academic_start_date3" class="form-control datepicker-1">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="academic_completion[]"
                                                            value="{{  $academic_history[3]->academic_completion ?? '' }}"
                                                            id="academic_completion3" class="form-control datepicker-1">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="academic_diplomas[]"
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        Responsibilities:<br>
                                                        <textarea width="100%" required name="reference_previous_responsibilities[]"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        Phone No#<input type="number" type="text"
                                                            ...
                                                            id="reference_previous_phone_no" class="form-control"> <br>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        From: <input type="text" name="previous_organization_from[]"
                                                            ...
                                                            id="reference__phone_no_from2" class="form-control FROM">
                                                        To: <input type="text"
                                                            name="reference_previous_organization_to[]"
                                                            value="{{  $employment[1]->reference_previous_organization_to ?? '' }}"
                                                            id="reference__phone_no_to2" class="form-control TO">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        Responsibilities:<br>
                                                        <textarea width="100%" name="reference_previous_responsibilities[]" id="reference_previous_responsibilities">{{  $employment[1]->reference_previous_responsibilities ?? '' }}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        From: <input type="text" name="previous_organization_from[]"
                                                            ...
                                                            id="reference__phone_no_from3" class="form-control FROM">
                                                        To: <input type="text"
                                                            name="reference_previous_organization_to[]"
                                                            value="{{  $employment[2]->reference_previous_organization_to ?? '' }}"
                                                            id="reference__phone_no_to3" class="form-control TO">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        Responsibilities:<br>
                                                        <textarea width="100%" name="reference_previous_responsibilities[]" id="reference_previous_responsibilities">{{  $employment[2]->reference_previous_responsibilities ?? '' }}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
