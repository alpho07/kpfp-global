...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
           Active  {{ trans('cruds.institution.title_singular') }} {{ trans('global.list') }}
        </div>
                                ...
                                <td>
                                    @if ($institution->logo)
                                        <a href="{{ $institution->logo->getUrl() }}" target="_blank">
                                            <img src="{{ $institution->logo->getUrl()  }}" width="50px"
                                                height="50px">
                                        </a>
                                    @endif
                                </td>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-Institution">
                    ...
                    <tbody>
                        @foreach ($inactiveInstitutions as $key => $institution)
                            <tr data-entry-id="{{ $institution->id }}">
                                <td>
