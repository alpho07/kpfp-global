    ...
    <body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
        <header class="app-header navbar">
            ...
            <a class="navbar-brand" href="#">
                <span class="navbar-brand-full">KPFP</span>
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown d-md-down-none">
                    Welcome {{ Auth::user()->name }}!  | {{session('institution_name')}}     <a class="btn btn-sm btn-danger" href="#"
                                                                                                onclick="event.preventDefault(); document.getElementById('logoutform').submit();"><i class="nav-icon fas fa-fw fa-sign-out-alt"></i>Logout</a>
        ...
        <script src="https://cdn.jsdelivr.net/npm/@ckeditor/ckeditor5-source-editing@40.2.0/src/index.min.js"></script>
